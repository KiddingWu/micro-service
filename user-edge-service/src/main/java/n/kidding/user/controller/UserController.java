package n.kidding.user.controller;
...
import n.kidding.user.redis.RedisClient;
import n.kidding.user.response.LoginResponse;
import n.kidding.user.response.Response;
import n.kidding.user.thrift.ServiceProvider;
...
public class UserController {
     ...
     * 发送验证码
     */
    @RequestMapping(value = "/sendVerityCode", method = RequestMethod.POST)
    @ResponseBody
